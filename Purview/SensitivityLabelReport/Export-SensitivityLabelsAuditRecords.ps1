...
#
#
/* Button: Filter Downgrades (standout) */
#
#
#
#
...
/* Styling notes: brief; ID selector used intentionally. */
#
#
#
#
...
/* Downgrades button standout color */
#
#
#
#
...
# Target by id
# Warn: this is deliberate for specificity
#
# The rule:
#
#
